...
const features = [
  ...
  },
  {
    ...
    description: 'Get the final destination immediately. Check Redirects is blazingly fast. Cached for fast retrievals.',
    icon: ForwardIcon,
  },
  {
    ...
    <div id="features" className="py-12 bg-gray-50">
      <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:py-24 lg:px-8">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl font-extrabold text-gray-900">All-in-one URL
            analysis platform</h2>
          ...
          {features.map((feature) => (
            <div key={feature.name}>
              <dt>
                ...
                <p
                  className="mt-5 text-lg leading-6 font-medium text-gray-900">{feature.name}</p>
              </dt>
              <dd
                className="mt-2 text-base text-gray-500">{feature.description}</dd>
            </div>
          ))}
        </dl>
      </div>
