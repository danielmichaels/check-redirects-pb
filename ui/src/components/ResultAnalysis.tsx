                ...
                {({open}) => (
                  <>
                    ...
                    <Disclosure.Panel>
                      <div>
                        <nav className="mx-4 relative z-0 rounded-lg shadow flex divide-x divide-gray-200" aria-label="Tabs">
                          {tabs.map((tab) => (
                            ...
                            >
                              <span>{tab.name}</span>
                              <span aria-hidden="true" className="absolute inset-x-0 bg-indigo-500" />
                            </a>
                          ))}
                          <button
                            id={`body-${hop.id}`}
                      ...
                      <div id={`ip-info-${hop.id}`} className="grid grid-cols-1 mx-auto xl:grid-cols-4 lg:grid-cols-4">
                        ...
                        <div id={`map-${hop.id}`} className="xl:col-span-2 lg:col-span-2">
                          <div className="px-4 py-5 sm:p-6">
                            <h3 className="text-lg text-indigo-500 my-3 mx-auto">
