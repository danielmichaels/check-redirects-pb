...
export type HopsRecord<Theaders = unknown, Tipinfo = unknown> = {
  body?: HTMLString;
  created?: IsoDateString;
...
export type HopsResponse<
  ...
  Tipinfo = unknown,
  Texpand = unknown,
> = Required<HopsRecord<Theaders, Tipinfo>> & BaseSystemFields<Texpand>;
...
export type TypedPocketBase = PocketBase & {
  ...
  collection(idOrName: "hops"): RecordService<HopsResponse>;
